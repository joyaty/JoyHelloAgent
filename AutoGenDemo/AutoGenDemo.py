...
def create_productManager(model_client):
    """
    创建产品经理智能体
    """
    ## 产品经理智能体提示词
...
def create_user_proxy():
    ...
    创建用户代理智能体
    """
    return UserProxyAgent(name="UserProxy", description="""
                          用户代理，负责以下职责：
                            1. 代表用户提出开发需求
                            2. 执行最终的代码实现
                            3. 验证功能是否符合预期
...
async def run_software_development_team():
    ...
    print("正在创建智能体团队...")
    # 创建智能体团队
    product_manager = create_productManager(llm_client)
